          ...
          <div className="mt-20">
            ...
            <div className="space-y-6">
              {freelanceProjects.map((project) => (
                ...
                >
                  <div className="flex flex-wrap items-center gap-3">
                    <h3 className="font-display text-xl font-semibold text-text">{project.company}</h3>
                    <span className="rounded-full bg-accent-soft px-3 py-1 text-[11px] font-medium uppercase tracking-wide text-accent">
                      Freelance Project
                    </span>
                  </div>

                  <p className="mt-3 max-w-2xl text-balance leading-relaxed text-muted">{project.tagline}</p>
